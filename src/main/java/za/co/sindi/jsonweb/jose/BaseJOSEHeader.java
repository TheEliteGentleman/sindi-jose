...
import za.co.sindi.jsonweb.jose.jwk.JWKeys;
 ...
 *
 */
public abstract class BaseJOSEHeader<JWA extends Algorithm> extends AbstractJWObject implements JOSEHeader<JWA> {
