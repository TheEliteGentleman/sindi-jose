 ...
 *
 */
public class JWEHeader extends BaseJOSEHeader<JWEAlgorithm> implements JWEJOSEHeader, JOSEHeader<JWEAlgorithm> {
	...
	static {
		...
		registeredHeaderNames.add(za.co.sindi.jsonweb.jose.jwe.Constants.JWE_HEADER_ENCRYPTION_ALGORITHM);
		registeredHeaderNames.add(za.co.sindi.jsonweb.jose.jwe.Constants.JWE_HEADER_COMPRESSION_ALGORITHM);
